...
class SeniorHigh extends RestController
{
	...
	{
		$seniorhigh = new SeniorHighModel;
		$result = $seniorhigh->pending(); // current pending list
		$this->response($result, RestController::HTTP_OK);
	}
	...
	public function filter_pending_post()
	{
		...
		$result = $seniorhigh->filter_pending($data);
		$this->response($result, RestController::HTTP_OK);
	}
	...
	{
		$seniorhigh = new SeniorHighModel;
		$result = $seniorhigh->approved(); // current approved list
		$this->response($result, RestController::HTTP_OK);
	}
	...
	{
		$seniorhigh = new SeniorHighModel;
		$result = $seniorhigh->all_approved();  
		$this->response($result, RestController::HTTP_OK);
	}
	...
	public function filter_approved_post()
	{
		...
		$result = $seniorhigh->filter_approved($data);
		$this->response($result, RestController::HTTP_OK);
	}
	public function archived_get()
	{
		$seniorhigh = new SeniorHighModel;
		$result = $seniorhigh->archived(); // current archived list
		$this->response($result, RestController::HTTP_OK);
	}
	public function total_get()
	{
		$seniorhigh = new SeniorHighModel;
		$result = (int) $seniorhigh->total(); // current total list
		$this->response($result, RestController::HTTP_OK);
	}
